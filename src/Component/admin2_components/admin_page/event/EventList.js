...
export default function EventList() {
  ...
  useEffect(() => {
    axios
      .get(
        "http://localhost/Reactjs/31-01-24/seelife/backend/crud/event/getEvent.php"
      )
  ...
  const deleteCause = (id) => {
    axios
      .get(
        `http://localhost/Reactjs/31-01-24/seelife/backend/crud/event/deleteEvent.php?id=${id}`
      )
      .then((res) => {
                      ...
                      {data.map((d, i) => {
                        return (
                          <tr key={i}>
                            ...
                            <td>
                              <NavLink to={`/admin/updateevent/${d.id}`}>
